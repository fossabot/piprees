  ...
  return (
    <section class={Blocks.Container}>
      <div class={Blocks.Column}>
        <h2 id="career"><a href="#career"><i>👨‍💻</i>Career Summary</a></h2>
        ...
        <Summary id="career-summary" text="At Cruise Nation, I work closely with management, marketing, and product teams to design, implement, and regularly ship web features, optimisations, and UI improvements to thousands of visitors every month across a wide range of browsers and devices as part of an award-winning digital team.">
