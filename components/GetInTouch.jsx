    ...
    <>
      <section class={Blocks.Container}>
        <div class={Blocks.Column}>
          <h2 id="contact"><a href="#contact"><i>📧</i>Get In Touch</a></h2>
          <p id="contact-intro">I&apos;m always open to hearing about exciting full-time and remote opportunities, so if you&apos;d like to discuss roles, experience, or just have a chat, don&apos;t hesitate to contact me.</p>
          <ContactForm />
        </div>
      </section>
      <section class={Blocks.Container}>
        <div class={Blocks.ColumnHalf}>
          <h3 id="hangouts"><a href="#hangouts"><i>👉</i>Hangouts</a></h3>
          <ul id="contact-links">
        ...
        <div class={Blocks.ColumnHalf}>
          <h3 id="recruiting"><a href="#recruiting"><i>✅</i>Recruiting?</a></h3>
          <ul id="contact-resume">
            <li><a href="https://piprees.dev/PipReesCV.pdf" target="_blank" rel="nofollow noreferrer" onClick={() => linkClicked('DownloadCV', 'https://piprees.dev/PipReesCV.pdf')}><i>📝</i>Download CV</a></li>
